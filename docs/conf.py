...
# Unclear why this is necessary, but mermaid doesn't render without lowering this priority setting.
# Se https://github.com/mgaitan/sphinxcontrib-mermaid/issues/68 for partial breadcrumbs on this.
mermaid_js_priority = 201
...
# By default, we all either restructured text (.rst) or markdown (.md)
source_suffix = {
...
version = power_dashboard.__version__
